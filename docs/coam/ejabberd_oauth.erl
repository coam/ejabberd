...
%%% Created : 20 Mar 2016 by Alexey Shchepin <alexey@process-one.net>
%%%
%%%
    ...
    case catch mnesia:dirty_read(oauth_token, Token) of
        [#oauth_token{us = {LUser, LServer},
            ...
            oauth2_priv_set:is_member(
                ...
                Expire > TS;
%%                Scope, oauth2_priv_set:new(TokenScope));
        _ ->
            false
    end.
    ...
    case catch mnesia:dirty_read(oauth_token, Token) of
        [#oauth_token{us = {LUser, LServer},
            ...
            case oauth2_priv_set:is_member(
                Scope, oauth2_priv_set:new(TokenScope)) andalso
                Expire > TS of
%%                Scope, oauth2_priv_set:new(TokenScope)) of
...
web_head() ->
    [?XA(<<"meta">>, [{<<"http-equiv">>, <<"X-UA-Compatible">>},
        ...
        ?XC(<<"title">>, <<"Authorization request-222">>),
        ?XC(<<"style">>, css())
    ].
